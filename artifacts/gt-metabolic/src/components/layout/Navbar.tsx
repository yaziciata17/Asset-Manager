    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <div className="flex flex-col">
          <span className="text-primary font-bold text-lg leading-none tracking-tight">GT Metabolic Solutions</span>
          <span className="text-muted-foreground text-xs font-medium uppercase tracking-widest mt-1">Cerrahpaşa Training Center</span>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-8 text-sm font-medium text-slate-600">
          ...
          <button onClick={() => scrollTo('equipment')} className="hover:text-primary transition-colors">Equipment</button>
        </div>
